...
<tr>
<td>Device</td>
<td>「デバイス」「携帯電話」ではなく「端末」に統一する。ただし、「[Android デバイス マネージャー](https://www.google.com/android/devicemanager?u=0)]」など固有名詞に使われている場合と、「Bluetooth デバイス」「USB デバイス」などスマートフォン・タブレット以外に対して使用される場合は例外とする。</td>
</tr>
<tr>
<td>Phone</td>
